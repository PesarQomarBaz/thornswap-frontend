      ...
      <Hero>
        <div>
          <Heading as="h1" size="xxl" mb="16px">
            {TranslateString(738, 'Thorny Pools')}
          </Heading>
          <ul>
            <li>{TranslateString(580, 'Stake THORN to earn new tokens.')}</li>
            <li>{TranslateString(486, 'You can unstake at any time.')}</li>
            <li>{TranslateString(406, 'Rewards are calculated per block.')}</li>
          </ul>
        </div>
        <img src="/images/thorn-pool.jpg" alt="SYRUP POOL icon" width={150} height={191} />
      </Hero>
